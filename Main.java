...
if(amountPaid%amountDebtorPayPerDay>0 && amountPaid<totalAmount){
  ...
  System.out.println("The amount left to complete the payment for day " + daysOfTheMonthDebtorDefaulted[daysDebtorPaidFor] +" is #" + (amountDebtorPayPerDay - (amountPaid%amountDebtorPayPerDay)));
}
